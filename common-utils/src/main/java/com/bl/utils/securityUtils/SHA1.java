...
public class SHA1 {
    ...
    public static String getDigestOfString(String... arr) { 
   	 Arrays.sort(arr);
       ...
       return byteArrayToHexString(getDigestOfBytes(sb.toString().getBytes())); 
   } 
    /**
    ...
    public static void main(String[] args) {
        String str1 = "{\"nickName\":\"Band\",\"gender\":1,\"language\":\"zh_CN\",\"city\":\"Guangzhou\",\"province\":\"Guangdong\",\"country\":\"CN\",\"avatarUrl\":\"http://wx.qlogo.cn/mmopen/vi_32/1vZvI39NWFQ9XM4LtQpFrQJ1xlgZxx3w7bQxKARol6503Iuswjjn6nIGBiaycAjAtpujxyzYsrztuuICqIM5ibXQ/0\"}HyVFkGl5F5OQWJZZaNzBBg==";
        System.err.println(getDigestOfString(str1).toLowerCase());
    }
}
